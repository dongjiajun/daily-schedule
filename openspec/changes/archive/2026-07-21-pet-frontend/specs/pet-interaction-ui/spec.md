...
|----------|--------|----------|------|
| 菜单弹出 | PetMenu.test.tsx | shouldOpenPopover | ➕ |
| 喂食成功 | PetMenu.test.tsx | shouldFeedPet | ➕ |
| 专注币不足 | PetMenu.test.tsx | shouldDisableWhenNoCoins | ➕ |
| 玩耍 | PetMenu.test.tsx | shouldPlayWithPet | ➕ |
| 商店列表 | PetMenu.test.tsx | shouldShowShopItems | ➕ |
