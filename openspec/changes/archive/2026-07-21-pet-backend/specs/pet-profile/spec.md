...
|----------|--------|----------|------|
| 创建成功 | PetControllerTest | shouldCreatePet | ➕ |
| 重复创建 409 | PetControllerTest | shouldRejectDuplicatePet | ➕ |
| 非法参数 400 | PetControllerTest | shouldRejectInvalidParams | ➕ |
| 查询已有宠物 | PetControllerTest | shouldGetMyPet | ➕ |
| 无宠物 404 | PetControllerTest | shouldReturn404WhenNoPet | ➕ |
| 改名成功 | PetControllerTest | shouldUpdatePetName | ➕ |
| 数据隔离 | PetApplicationServiceTest | shouldIsolateByUserId | ➕ |
