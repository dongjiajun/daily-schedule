...
|----------|--------|----------|------|
| 正常衰减 | PetDomainServiceTest | shouldDecayMoodAndHunger | ➕ |
| 下限保护 | PetDomainServiceTest | shouldNotDecayBelowZero | ➕ |
| 刚互动不衰减 | PetDomainServiceTest | shouldNotDecayRecentInteraction | ➕ |
| 经验/等级不变 | PetDomainServiceTest | shouldNotDecayExpOrLevel | ➕ |
| 无宠物用户 | PetStatusSchedulerTest | shouldHandleNoPets | ➕ |
| 加速间隔配置 | PetStatusSchedulerTest | shouldRespectCustomInterval | ➕ |
