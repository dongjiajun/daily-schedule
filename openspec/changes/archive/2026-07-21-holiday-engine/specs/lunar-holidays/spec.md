...
|----------|--------|----------|------|
| 2026 春节 | lunar.test.ts | shouldGetSpringFestival2026 | ➕ |
| 春节初三 | lunar.test.ts | shouldMatchSpringFestivalDay3 | ➕ |
| 春节范围外 | lunar.test.ts | shouldNotMatchOutsideRange | ➕ |
| 2026 中秋 | lunar.test.ts | shouldGetMidAutumn2026 | ➕ |
| 2026 端午 | lunar.test.ts | shouldGetDragonBoat2026 | ➕ |
| 元宵/七夕/重阳/清明 | lunar.test.ts | shouldGetOtherLunarHolidays | ➕ |
| 非节日空返回 | lunar.test.ts | shouldReturnEmptyForNonHoliday | ➕ |
