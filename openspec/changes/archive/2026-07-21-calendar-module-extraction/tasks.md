...
- [ ] 6.5 验证：手动测试 — 桌面端 Sidebar 正常显示日历筛选，移动端抽屉正常开关
...
- [ ] 10.1 日历视图切换（月/周/日/议程）正常
- [ ] 10.2 创建/编辑/删除日程正常
- [ ] 10.3 拖拽改期 + 拉伸时长正常
- [ ] 10.4 日程状态流转（PLANNED → COMPLETED / CANCELLED）正常
- [ ] 10.5 分类筛选 / 标签筛选 / 搜索正常
- [ ] 10.6 ICS 导出正常
- [ ] 10.7 主题切换（5 套）正常
- [ ] 10.8 键盘快捷键正常（N/T/←→/1-4/?/Esc）
- [ ] 10.9 移动端抽屉侧边栏正常（打开/关闭/导航）
- [ ] 10.10 引导流程正常（首次登录显示 Onboarding）
- [ ] 10.11 分类/标签 CRUD + 偏好设置（TabbedDialog）正常
