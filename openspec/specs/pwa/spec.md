...
PWA 渐进式增强：提供 manifest、Service Worker 与离线缓存，让用户像原生应用一样从桌面/主屏幕一键打开日程管理系统，并支持离线访问静态资源。

## Requirements

### Requirement: Web App Manifest

应用 SHALL 通过 `vite-plugin-pwa` 自动生成 `manifest.webmanifest`，符合 W3C Web App Manifest 规范。
