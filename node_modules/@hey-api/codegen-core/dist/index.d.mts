...
type Scope = {
  /** Child scopes. */children: Array<Scope>; /** Resolved names in this scope. */
  localNames: NameScopes; /** Parent scope, if any. */
  parent?: Scope; /** Symbols registered in this scope. */
...
type ExportModule = Pick<ExportMember, 'isTypeOnly'> & {
  /** Whether this module can export all symbols: `export * from 'module'`. */canExportAll: boolean; /** Members exported from this module. */
  exports: Array<ExportMember>; /** Source file. */
  from: File; /** Namespace export: `export * as ns from 'module'`. Mutually exclusive with `exports`. */
...
type ImportModule = Pick<ImportMember, 'isTypeOnly'> & Pick<Partial<ImportMember>, 'localName'> & {
  /** Source file. */from: File; /** List of symbols imported from this module. */
  imports: Array<ImportMember>; /** Import flavor. */
  kind: BindingKind;
};
//#endregion
