...
import { Download, HelpCircle, Keyboard, Layers, Plus, Search, Settings, Tag as TagIcon } from 'lucide-react'
...
export function CalendarSidebar({ onNavigate }: { onNavigate?: () => void }) {
