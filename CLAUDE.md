...
测试覆盖：37 类 259 用例（后端 H2，`<!-- DOCS-CHECK: backend-test-classes=37 -->`）+ 50 文件 238 用例（前端 vitest，`<!-- DOCS-CHECK: frontend-test-files=50 -->`）+ 11 文件 39 用例（Playwright E2E，`<!-- DOCS-CHECK: e2e-files=11 -->`）
