...
测试覆盖：37 类 259 用例（后端 H2，`<!-- DOCS-CHECK: backend-test-classes=37 -->`）+ 47 文件 211 用例（前端 vitest，`<!-- DOCS-CHECK: frontend-test-files=47 -->`）+ 10 文件 35 用例（Playwright E2E，`<!-- DOCS-CHECK: e2e-files=10 -->`）
