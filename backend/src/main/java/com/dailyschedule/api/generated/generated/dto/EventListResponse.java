...
public class EventListResponse {
  ...
  public EventListResponse code(Integer code) {
    this.code = code;
    return this;
  }
  ...
  public EventListResponse data(List<@Valid EventResponse> data) {
    this.data = data;
    return this;
  }

  public EventListResponse addDataItem(EventResponse dataItem) {
    if (this.data == null) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.code, eventListResponse.code) &&
        Objects.equals(this.message, eventListResponse.message) &&
        Objects.equals(this.data, eventListResponse.data);
  }
